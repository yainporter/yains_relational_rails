...
RSpec.describe 'Person Show Page', type: :feature do
  before(:each) do
    ...
    visit persons_show_path(@marlane.id)
  end

  describe 'User Story 4 - Person Show' do
    it "displays the person's attributes" do
